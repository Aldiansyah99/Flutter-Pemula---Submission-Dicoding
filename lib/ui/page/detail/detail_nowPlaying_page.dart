...
class DetailNowPlaying extends StatefulWidget {
  ...
  DetailNowPlaying({@required this.nowplaying});

  @override
  _DetailNowPlayingState createState() => _DetailNowPlayingState();
}
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(widget.nowplaying.title,
                style: whiteTextFont.copyWith(fontSize: 25)),
            SizedBox(
              height: 4,
            ),
            Text('Release Date : ' + widget.nowplaying.release,
