...
class DetailPopular extends StatefulWidget {
  ...
  DetailPopular({@required this.popular});

  @override
  _DetailPopularState createState() => _DetailPopularState();
}
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(widget.popular.title, style: whiteTextFont.copyWith(fontSize: 25)),
            SizedBox(
              height: 4,
            ),
            Text('Release Date : ' + widget.popular.release,
